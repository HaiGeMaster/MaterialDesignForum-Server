...
class Config
{
  ...
  public static function getConfig()
  {
    ...
    //以下是可以修改的配置↓
    $config['mysql_hostname'] = '{mysql_hostname}'; //数据库地址
    $config['mysql_username'] = '{mysql_username}'; //数据库用户名
    $config['mysql_password'] = '{mysql_password}'; //数据库密码
    $config['mysql_database'] = '{mysql_database}'; //'root';//数据库名
